...
class _isHTTPUrl(Validator):
    ...
    official_top_level_domains = [
        ...
        'dm', 'do', 'dz', 'ec', 'edu', 'ee', 'eg', 'eh', 'er', 'es', 'et',
        'eu', 'example', 'fi', 'fj', 'fk', 'fm', 'fo', 'fr', 'ga', 'gb', 'gd',
        'ge', 'gf', 'gg', 'gh', 'gi', 'gl', 'gm', 'gn', 'gov', 'gp', 'gq',
        'gr', 'gs', 'gt', 'gu', 'gw', 'gy', 'hk', 'hm', 'hn', 'hr', 'ht',
        'hu', 'id', 'ie', 'il', 'im', 'in', 'info', 'int', 'invalid', 'io',
        'iq', 'ir', 'is', 'it', 'je', 'jm', 'jo', 'jobs', 'jp', 'ke', 'kg',
        'kh', 'ki', 'km', 'kn', 'kp', 'kr', 'kw', 'ky', 'kz', 'la', 'lb',
        'lc', 'li', 'lk', 'localhost', 'lr', 'ls', 'lt', 'lu', 'lv', 'ly',
        ...
        'so', 'sr', 'st', 'su', 'sv', 'sy', 'sz', 'tc', 'td', 'tel', 'test',
        'tf', 'tg', 'th', 'tj', 'tk', 'tl', 'tm', 'tn', 'to', 'tp', 'tr',
        'travel', 'tt', 'tv', 'tw', 'tz', 'ua', 'ug', 'uk', 'um', 'us', 'uy',
        ...
        'xn--hlcj6aya9esc7a', 'xn--jxalpdlp', 'xn--kgbechtv', 'xn--p1ai',
                    ...
                    if self.GENERIC_VALID_IP.match(authority):
                        ...
                        if domainMatch:
                            ...
                            if domainMatch.group(5).lower()\
                                    in self.official_top_level_domains:
                                # Then this HTTP URL is valid
                                return (value, None)
                else:
