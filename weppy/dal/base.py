...
class DAL(object):
    ...
    def __init__(self, app,
        ...
        #: load config data
        check_reserved = config.check_reserved or check_reserved
        migrate = config.migrate or migrate
        fake_migrate = config.fake_migrate or fake_migrate
        ...
        if self.check_reserved:
            from .helpers.reserved import ADAPTERS as RSK
            self.RSK = RSK
