# -*- coding: utf-8 -*-
"""
emmett.orm.migrations.revisions
-------------------------------
...
from .helpers import dedupe_tuple, to_tuple, tuple_or_value
...
class RevisionsMap(object):
    ...
    def _iterate_revisions(self, upper, lower, inclusive=True, implicit_base=False):
        ...
        total_space = {rev.revision for rev in upper_ancestors}.intersection(
            rev.revision for rev in self._get_descendant_nodes(lowers, check=True)
        )
